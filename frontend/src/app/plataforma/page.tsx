 ...
 *
 *  A lista de tenants e a tela de entitlements moram aqui quando chegarem: hoje o `/me` de cada
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            ...
            entitlements ganham tela nas próximas entregas; para abrir uma organização, navegue para{' '}
            <code className="font-mono text-xs">/organizacoes/&#123;orgId&#125;</code>.
          </CardDescription>
        </CardHeader>
      </Card>
    </div>
