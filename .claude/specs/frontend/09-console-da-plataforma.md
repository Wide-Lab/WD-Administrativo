...
**Depende de:** `backend/03-organizacoes-e-tenancy.md` (provisionar tenant),
`backend/05-modulos-e-entitlements.md` (o catálogo e o entitlement),
`frontend/04-casca-e-personas.md` (a `PlatformShell`, que já existe e está vazia).
