...
**Estado:** ✅ implementada (`3b76bf8`, 2026-07-16). Ver [`como-ficou.md`](./como-ficou.md).
**Depende de:** `frontend/01-fundacao/spec.md`, `frontend/02-design-system/spec.md`,
`backend/02-identidade-e-sessao/spec.md`.
