...
**Depende de:** `backend/10-frota/spec.md` (as 14 rotas e as sete capabilities — está inteiro e
observável por requisição), `frontend/04-casca-e-personas/spec.md` (a casca, o `Can`, o `ModuleGuard`),
`frontend/02-design-system/spec.md` (os tokens).
