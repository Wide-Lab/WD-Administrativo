...
**Estado:** ✅ implementada (2026-07-16). Fecha a fase 1 do frontend. Ver [`como-ficou.md`](./como-ficou.md) —
em especial a **terceira tela do critério 3, que não existe**, e a tensão entre os critérios 2 e 4.
**Depende de:** `frontend/03-login-e-sessao/spec.md`, `backend/06-convites-e-onboarding/spec.md`.
