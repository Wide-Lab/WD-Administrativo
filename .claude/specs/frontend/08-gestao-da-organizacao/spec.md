...
browser** — ver [`como-ficou.md`](./como-ficou.md), que separa o que tem teste do que ficou por inspeção visual.
**Depende de:** `backend/04-membros-e-autorizacao/spec.md` (membros e papéis),
`backend/08-gestao-de-convites/spec.md` (listar e revogar convite — a spec que nomeou esta aqui),
`backend/03-organizacoes-e-tenancy/spec.md` (convênios), `frontend/04-casca-e-personas/spec.md` (a casca e
o `Can`).
