...
**Estado:** ✅ implementada (2026-07-16). Ver [`como-ficou.md`](./como-ficou.md) — em especial a ordem de
precedência do redirect, que **muda uma decisão da `04`**, e quem observou cada critério.
**Depende de:** `frontend/04-casca-e-personas/spec.md`, `backend/03-organizacoes-e-tenancy/spec.md`.
