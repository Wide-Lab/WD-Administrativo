...
**Estado:** ✅ implementada (2026-07-16). Fecha a fase 1 do frontend e aposenta a `/` placeholder
da `03`. Ver [`como-ficou.md`](./como-ficou.md) — em especial de onde vieram os metadados de navegação.
**Depende de:** `frontend/03-login-e-sessao/spec.md`, `backend/04-membros-e-autorizacao/spec.md`,
`backend/05-modulos-e-entitlements/spec.md`.
