...
Ver [`como-ficou.md`](./como-ficou.md).
**Depende de:** `backend/09-capabilities-de-modulo/spec.md` (sem ele, `require_permission` de
capability de módulo nega todo mundo), `backend/05-modulos-e-entitlements/spec.md` (o descritor, o
`mount_module`, o `require_module`), `backend/04-membros-e-autorizacao/spec.md` (papéis e persona),
