...
235 testes (216 + 19), sem migration. Ver [`como-ficou.md`](./como-ficou.md).
**Depende de:** `backend/06-convites-e-onboarding/spec.md` (o modelo `invitations`, o aceite, o
mapa de papéis/permissões), `backend/07-testes/spec.md` (a suíte que os critérios abaixo estendem).
